"""
 * @File       : Source_Meter_Model.py
 * @Version    : V1.0.0
 * @Date       : April 27, 2022
 * @Brief      : Child class of Source Meter.
 * @Author     : Rex Wang
 * @Last editor: Rex Wang
 * Copyright (C) 2022 Alpha & Omega Semiconductor Ltd. All rights reserved.
"""

from Library.INSTR import Source_Meter

class Keithley_2400(Source_Meter):
    Model_Nmae = "Keithley_2400"
    ...
    CMD_Set_Source_Current_Amplitude = ":SOURce:CURRent:LEVel:IMMediate:AMPLitude %.7f"
    ...
    CMD_Set_Source_Voltage_Amplitude = ":SOURce:VOLTage:LEVel:IMMediate:AMPLitude %.7f"
    CMD_Set_Source_Voltage_Limit = ":SOURce:VOLTage:PROTection %f"
    CMD_Set_Source_Voltage_Range = ":SOURce:VOLTage:RANGe %f"

class Keysight_E3632A(Source_Meter):
    Model_Nmae = "Keysight_E3632A"
    ...
    CMD_Set_Concurrent_Measurement_State_Off = ""
    CMD_Set_Concurrent_Measurement_State_On = ""
    CMD_Set_Idle = ""
    ...
    CMD_Set_Sense_Current_Range_Auto_State = ""
    CMD_Set_Sense_Voltage_Limit = ""
    CMD_Set_Sense_Voltage_Range = ""
    CMD_Set_Sense_Voltage_Range_Auto_State = ""
    CMD_Set_Source_Current_Amplitude = ""
    CMD_Set_Source_Current_Limit = ""
    CMD_Set_Source_Current_Range = ""
    CMD_Set_Source_Mode = ""
    CMD_Set_Source_Voltage_Amplitude = "SOURce:VOLTage %.3f"
